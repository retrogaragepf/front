    ...
    <div className="w-full min-h-screen bg-amber-100">
      <main className="max-w-6xl mx-auto px-4 py-10">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link
            href="/"
            className="bg-emerald-900 font-typewriter inline-flex items-center justify-center rounded-xl  px-5 py-3 text-white text-sm hover:bg-amber-800"
          >
            Volver al Home
          </Link>
        </header>
        ...
        <section className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <aside className="lg:col-span-1 space-y-4">
            <div className="rounded-2xl bg-amber-100 text-black p-6">
              <h3 className="text-lg font-bold font-typewriter">
                Lo que defendemos
              </h3>
              <ul className="mt-4 space-y-3 text-sm text-black font-typewriter">
                ...
                <li className="flex gap-2">
                  <span className=" font-typewriter mt-1 h-2 w-2 rounded-full bg-amber-300" />
            ...
            <div className="rounded-2xl border border-black/10 bg-amber-200 backdrop-blur p-6">
              <h3 className="font-typewriter text-lg font-bold text-black">
                ¿Qué puedes hacer aquí?
              </h3>
              <ul className="font-typewriter mt-3 space-y-2 text-sm text-black/80">
              ...
              <Link
                href="/product"
                className="font-typewriter mt-5 inline-flex w-full items-center justify-center rounded-xl border border-black/20 bg-emerald-900 px-5 py-3 text-sm  text-amber-50 hover:bg-amber-800 "
              >
                Ir a ver productos
              </Link>
            </div>
        ...
        <footer className="font-typewriter mt-12 rounded-2xl border border-black/10 bg-amber-200 p-6 text-sm text-black/70">
