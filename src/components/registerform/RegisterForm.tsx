          ...
          <div className="bg-amber-100 rounded-3xl shadow-lg p-8 space-y-6 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 border border-gray-900 bg-amber-100 hover:bg-gray-50 text-gray-800 font-medium py-3 px-4 rounded-xl transition-colors"
              >
              ...
              <p className="text-center text-sm text-gray-900 pt-4">
                ¿Ya tienes cuenta?{" "}
                <Link
                  href="/login"
                  className=" text-gray-900 hover:text-amber-800 transition-colors"
                >
                  Inicia sesión
                </Link>
              </p>
